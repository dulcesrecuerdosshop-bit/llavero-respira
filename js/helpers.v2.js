...
(function () {
  ...
  async function startBreathFlowInternal() {
    ...
    loopStep();
    overlay._stop = () => { running = false; if (timeoutId) clearTimeout(timeoutId); stopAmbientLoop(); if (overlay.parentNode) overlay.parentNode.removeChild(overlay); console.log('[helpers] overlay stopped'); };
